...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        nowPlayingNavigationController.tabBarItem.image = UIImage(named: "iconmonstr-video-8-240")
        ...
        topRatedNavigationController.tabBarItem.image = UIImage(named: "iconmonstr-star-2-240")
